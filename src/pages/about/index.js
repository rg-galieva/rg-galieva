                ...
                <div className="col_10">
                    <div className={s.desc}>
                        ...
                        <p>The story of my relationships with web technologies begins in the distant 1999. When I
                            ...
                            awesome.
                            I got a five for diligence and left to grow up. In 2008 we met again. But this time it
                            was a
                            serious long-term partnership.</p>

                        <p>Since that time I've seen a lot. Battle of table and div layouts. I fought for divs.
                            Carefully
                            glued image sprites to create rounded borders. Yes, I was dreaming about border-radius
                            for
                            so
                            long. I saw the dawn and sunset of jQuery. I remember how all script tags were moved
                            from
                            the
                            head to the end of body all around the web. Bragged to server developers with my
                            application
                            on Express.</p>

                        <p>In mid-2012, I was bored and I plunged into the world of server Java development. After 6
                            months of debugging errors in the console, I decided to test the sass, Backbone, and
                            grunt.
                        ...
                        <p>Todays I would love to create PWA and score 100 points on Google Lighthouse, write an app
                            about barware (or whatever ware)) using React-native. And find a dream team to work
                            together
                            on great projects!
                        </p>
                    </div>
